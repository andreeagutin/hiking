...
const TRANSLATIONS = {
  ro: {
    ...
    'footer.hikingCalculator':   'Calculator drumeție',
    'footer.info':               'Info',
    ...
    'track.startNew':            'Înregistrează drumeție',
    'track.noTracks':            'Nicio drumeție înregistrată încă.',
    'track.loginRequired':       'Trebuie să fii autentificat pentru a înregistra drumeții.',
    'track.points':              '{{n}} puncte',
    'track.active.title':        'Înregistrare activă',
    'track.active.elapsed':      'Timp',
    'track.active.distance':     'Distanță',
    'track.active.elevation':    'Altitudine',
    'track.active.speed':        'Viteză',
    'track.active.accuracy':     'Precizie GPS',
    'track.active.poorGps':      'GPS slab (>20m) — mergi în aer liber',
    'track.active.pause':        'Pauză',
    'track.active.resume':       'Continuă',
    'track.active.stop':         'Stop & Salvează',
    'track.active.recording':    'Înregistrare…',
    'track.active.paused':       'Pauză',
    'track.active.waitingGps':   'Se caută semnal GPS…',
    'track.save.title':          'Salvează traseul',
    'track.save.name':           'Numele drumeției',
    'track.save.namePlaceholder':'ex: Retezat – Lacul Bucura',
    'track.save.linkHike':       'Leagă de un traseu existent (opțional)',
    'track.save.linkNone':       '— Niciun traseu —',
    'track.save.notes':          'Notițe',
    'track.save.notesPlaceholder':'Observații, condiții meteo…',
    'track.save.saveProfile':    'Salvează în profil',
    'track.save.exportGpx':      'Exportă GPX',
    'track.save.discard':        'Renunță',
    'track.save.saving':         'Se salvează…',
    'track.save.preview':        'Previzualizare traseu',
    'track.detail.pace':         'Ritm mediu',
    'track.detail.totalDist':    'Distanță totală',
    'track.detail.duration':     'Durată',
    'track.detail.elevGain':     'Urcare',
    'track.detail.elevLoss':     'Coborâre',
    'track.detail.elevProfile':  'Profil altitudinal',
    'track.detail.compareRoute': 'Compară cu traseul oficial',
    'track.detail.exportGpx':    'Exportă GPX',
    'track.detail.delete':       'Șterge traseul',
    'track.detail.confirmDelete':'Ești sigur că vrei să ștergi această înregistrare?',
    'track.permissionDenied':    'Permisiunea de locație a fost refuzată.',
    'track.error.noLocation':    'Nu s-a putut obține locația. Verifică permisiunile GPS.',
    'track.mins':                'min',
    'track.km':                  'km',
    'track.mAlt':                'm alt.',
    'track.kmh':                 'km/h',
  ...
  en: {
    ...
    'footer.hikingCalculator':   'Hiking Calculator',
    'footer.info':               'Info',
    ...
    'track.startNew':            'Start New Hike',
    'track.noTracks':            'No recorded hikes yet.',
    'track.loginRequired':       'You must be signed in to record hikes.',
    'track.points':              '{{n}} points',
    'track.active.title':        'Active Tracking',
    'track.active.elapsed':      'Elapsed',
    'track.active.distance':     'Distance',
    'track.active.elevation':    'Elevation',
    'track.active.speed':        'Speed',
    'track.active.accuracy':     'GPS Accuracy',
    'track.active.poorGps':      'Poor GPS accuracy (>20m) — move to open sky',
    'track.active.pause':        'Pause',
    'track.active.resume':       'Resume',
    'track.active.stop':         'Stop & Save',
    'track.active.recording':    'Recording…',
    'track.active.paused':       'Paused',
    'track.active.waitingGps':   'Waiting for GPS signal…',
    'track.save.title':          'Save Track',
    'track.save.name':           'Hike name',
    'track.save.namePlaceholder':'e.g. Retezat – Lake Bucura',
    'track.save.linkHike':       'Link to existing trail (optional)',
    'track.save.linkNone':       '— None —',
    'track.save.notes':          'Notes',
    'track.save.notesPlaceholder':'Observations, weather conditions…',
    'track.save.saveProfile':    'Save to Profile',
    'track.save.exportGpx':      'Export GPX',
    'track.save.discard':        'Discard',
    'track.save.saving':         'Saving…',
    'track.save.preview':        'Track preview',
    'track.detail.pace':         'Avg. pace',
    'track.detail.totalDist':    'Total distance',
    'track.detail.duration':     'Duration',
    'track.detail.elevGain':     'Elevation gain',
    'track.detail.elevLoss':     'Elevation loss',
    'track.detail.elevProfile':  'Elevation Profile',
    'track.detail.compareRoute': 'Compare to Official Route',
    'track.detail.exportGpx':    'Export GPX',
    'track.detail.delete':       'Delete track',
    'track.detail.confirmDelete':'Are you sure you want to delete this recording?',
    'track.permissionDenied':    'Location permission was denied.',
    'track.error.noLocation':    'Could not get your location. Check GPS permissions.',
    'track.mins':                'min',
    'track.km':                  'km',
    'track.mAlt':                'm elev.',
    'track.kmh':                 'km/h',
